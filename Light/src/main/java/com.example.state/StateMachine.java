...
public class StateMachine {
    ...
    private Map<String, Map<String, State>> transitions; // state, triggered by event
    private Map<String, Function> functions; // process input data and produce output data.
    ...
    public void handleEvent(Event event) {
        ...
        log.info("Light:{}", currentState.getName());
    }
